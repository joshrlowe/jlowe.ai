...
export default function GlobalSettingsSection({ onError }: GlobalSettingsSectionProps) {
  ...
  const updateNavLink = (index: number, field: keyof NavLink, value: string | number) => {
