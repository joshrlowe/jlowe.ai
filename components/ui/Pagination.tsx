...
export const Pagination = forwardRef<HTMLDivElement, PaginationProps>(function Pagination(
  ...
  return (
    <div ref={ref} className={`flex justify-center items-center gap-4 ${className}`} {...props}>
      <button
        type="button"
      ...
      {showPageInfo && (
        <span className="text-[var(--color-text-secondary)]" aria-live="polite" aria-atomic="true">
