...
describe("Header Component", () => {
  ...
  describe("Navigation Links", () => {
    ...
    it("should highlight active link on home page", () => {
      ...
      const activeHomeLink = Array.from(homeLinks).find(
        (link) => link.textContent === "Home" && link.closest(".hidden.md\\:flex")
      );
  ...
  describe("Mobile Menu", () => {
    ...
    it("should close mobile menu when a link is clicked", () => {
      ...
      const mobileLink = mobileLinks.find((link) => link.closest(".md\\:hidden"));
      if (mobileLink) {
