  ...
  describe("Social Links", () => {
    ...
    it("should render GitHub link", async () => {
      ...
      await waitFor(() => {
        ...
        expect(githubLink.closest("a")).toHaveAttribute("href", "https://github.com/joshlowe");
      });
    });
    ...
    it("should render X (Twitter) link", async () => {
      ...
      await waitFor(() => {
        ...
        expect(xLink.closest("a")).toHaveAttribute("href", "https://x.com/joshlowe");
      });
    });
    ...
    it("should render Email link", async () => {
      ...
      await waitFor(() => {
        ...
        expect(emailLink.closest("a")).toHaveAttribute("href", "mailto:josh@jlowe.ai");
      });
    });
