...
describe("Card", () => {
  describe("rendering", () => {
    ...
    it('should render as custom element with "as" prop', () => {
      const { container } = renderWithoutProviders(<Card as="article">Article Card</Card>);
      const card = container.firstChild;
  ...
  describe("variants", () => {
    ...
    it("should render primary variant", () => {
      const { container } = renderWithoutProviders(<Card variant="primary">Primary</Card>);
      const card = container.firstChild;
      expect(card.className).toContain("bg-[rgba(232,93,4,0.08)]");
    });

    it("should render accent variant", () => {
      const { container } = renderWithoutProviders(<Card variant="accent">Accent</Card>);
      const card = container.firstChild;
      expect(card.className).toContain("bg-[rgba(250,163,7,0.08)]");
    });

    it("should render cool variant", () => {
      const { container } = renderWithoutProviders(<Card variant="cool">Cool</Card>);
      const card = container.firstChild;
      expect(card.className).toContain("bg-[rgba(76,201,240,0.08)]");
    });

    it("should render secondary variant", () => {
      const { container } = renderWithoutProviders(<Card variant="secondary">Secondary</Card>);
      const card = container.firstChild;
  ...
  describe("padding", () => {
    ...
    it("should apply no padding when padding is none", () => {
      const { container } = renderWithoutProviders(<Card padding="none">No Padding</Card>);
      const card = container.firstChild;
    ...
    it("should apply sm padding", () => {
      const { container } = renderWithoutProviders(<Card padding="sm">Small Padding</Card>);
      const card = container.firstChild;
      expect(card.className).toContain("p-4");
    });

    it("should apply lg padding", () => {
      const { container } = renderWithoutProviders(<Card padding="lg">Large Padding</Card>);
      const card = container.firstChild;
  ...
  describe("glow effect", () => {
    ...
    it("should not have glow when glow is false", () => {
      const { container } = renderWithoutProviders(<Card glow={false}>No Glow</Card>);
      const card = container.firstChild;
  ...
  describe("interactive mode", () => {
    ...
    it("should be interactive when interactive is true", () => {
      const { container } = renderWithoutProviders(<Card interactive>Interactive</Card>);
      const card = container.firstChild;
  ...
  describe("custom className", () => {
    it("should apply custom className", () => {
      const { container } = renderWithoutProviders(<Card className="my-custom-class">Custom</Card>);
      const card = container.firstChild;
      expect(card).toHaveClass("my-custom-class");
    });

    it("should merge with default classes", () => {
      const { container } = renderWithoutProviders(<Card className="extra-class">Merged</Card>);
      const card = container.firstChild;
  ...
  describe("accessibility", () => {
    it("should have no accessibility violations", async () => {
      const { container } = renderWithoutProviders(<Card>Accessible Card</Card>);
