...
describe("FormField", () => {
  ...
  describe("value and onChange", () => {
    ...
    it("should call onChange when input changes", async () => {
      ...
      const { user } = renderWithoutProviders(<FormField {...defaultProps} onChange={onChange} />);
  ...
  describe("placeholder", () => {
    it("should display placeholder in input", () => {
      renderWithoutProviders(<FormField {...defaultProps} placeholder="Enter value..." />);
      expect(screen.getByPlaceholderText("Enter value...")).toBeInTheDocument();
    });

    it("should display placeholder in textarea", () => {
      renderWithoutProviders(<FormField {...defaultProps} rows={4} placeholder="Enter text..." />);
  ...
  describe("required attribute", () => {
    ...
    it("should set required attribute on select", () => {
      renderWithoutProviders(
        <FormField {...defaultProps} options={[{ value: "a", label: "A" }]} required />
      );
  ...
  describe("custom classNames", () => {
    ...
    it("should apply inputClassName to input", () => {
      renderWithoutProviders(<FormField {...defaultProps} inputClassName="custom-input" />);
  ...
  describe("accessibility", () => {
    ...
    it("should render select with visual label", () => {
      renderWithoutProviders(
        <FormField {...defaultProps} options={[{ value: "a", label: "A" }]} />
      );
      expect(screen.getByText("Test Field")).toBeInTheDocument();
