...
describe("TeamMemberManager", () => {
  ...
  it("should add a new member with name only", async () => {
    ...
    expect(mockOnChange).toHaveBeenCalledWith([{ name: "Alice Johnson", email: null }]);
  });
  ...
  it("should add a new member with name and email", async () => {
    ...
    expect(mockOnChange).toHaveBeenCalledWith([{ name: "Bob Wilson", email: "bob@example.com" }]);
  });
  ...
  it("should remove a team member", async () => {
    ...
    expect(mockOnChange).toHaveBeenCalledWith([{ name: "Jane Smith", email: null }]);
  });
