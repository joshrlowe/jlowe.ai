...
describe('ImageUploader', () => {
  ...
  describe('Rendering', () => {
    it('should render with default label and empty images', () => {
      ...
      expect(screen.getByText((_, element) => element?.textContent === 'Project Images (0/10)')).toBeInTheDocument();
    ...
    it('should render existing images', () => {
      ...
      // Text is split across elements, use a function matcher
      expect(screen.getByText((_, element) => element?.textContent === 'Project Images (2/10)')).toBeInTheDocument();
    ...
    it('should show custom maxImages count', () => {
      ...
      // Text is split across elements, use a function matcher
      expect(screen.getByText((_, element) => element?.textContent === 'Project Images (0/5)')).toBeInTheDocument();
    });
