...
describe("ProjectPreview", () => {
  ...
  it("should return null when project is null", () => {
    const { container } = render(<ProjectPreview project={null} show={true} onHide={mockOnHide} />);
    expect(container.firstChild).toBeNull();
  });

  it("should render the preview modal when show is true", () => {
    render(<ProjectPreview project={mockProject} show={true} onHide={mockOnHide} />);
  ...
  it("should show Untitled when title is missing", () => {
    ...
    render(<ProjectPreview project={projectWithoutTitle} show={true} onHide={mockOnHide} />);
  ...
  it("should show Draft status with yellow styling", () => {
    ...
    render(<ProjectPreview project={draftProject} show={true} onHide={mockOnHide} />);
  ...
  it("should not show Featured badge when project is not featured", () => {
    ...
    render(<ProjectPreview project={nonFeaturedProject} show={true} onHide={mockOnHide} />);
  ...
  it("should not show Tech Stack section when techStack is empty", () => {
    ...
    render(<ProjectPreview project={projectWithoutTechStack} show={true} onHide={mockOnHide} />);
  ...
  it("should not show Tags section when tags is empty", () => {
    ...
    render(<ProjectPreview project={projectWithoutTags} show={true} onHide={mockOnHide} />);
  ...
  it("should handle tags as JSON string", () => {
    ...
    render(<ProjectPreview project={projectWithJsonTags} show={true} onHide={mockOnHide} />);
  ...
  it("should handle techStack as JSON string", () => {
    ...
    render(<ProjectPreview project={projectWithJsonTechStack} show={true} onHide={mockOnHide} />);
