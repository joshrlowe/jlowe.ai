...
describe("LoadingSpinner", () => {
  ...
  describe("custom className", () => {
    it("should apply custom className to container", () => {
      const { container } = renderWithoutProviders(<LoadingSpinner className="custom-loading" />);
      expect(container.firstChild).toHaveClass("custom-loading");
    });

    it("should merge with default container classes", () => {
      const { container } = renderWithoutProviders(<LoadingSpinner className="extra-class" />);
