...
describe("HeroSection Component", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should render hero title from homeContent", () => {
      render(<HeroSection data={mockData} homeContent={mockHomeContent} />);
  ...
  describe("CTA Buttons", () => {
    ...
    it("should link primary CTA to correct href", () => {
      const { container } = render(<HeroSection data={mockData} homeContent={mockHomeContent} />);
  ...
  describe("Edge Cases", () => {
    it("should handle empty techBadges array", () => {
      ...
      render(<HeroSection data={mockData} homeContent={contentWithEmptyBadges} />);
    ...
    it("should handle empty typingStrings array", () => {
      ...
      render(<HeroSection data={mockData} homeContent={contentWithEmptyStrings} />);
    ...
    it("should handle missing primaryCta", () => {
      ...
      render(<HeroSection data={mockData} homeContent={contentWithoutPrimaryCta} />);
    ...
    it("should handle missing secondaryCta", () => {
      ...
      render(<HeroSection data={mockData} homeContent={contentWithoutSecondaryCta} />);
      // Should render default CTA
      expect(screen.getByText("Get in Touch")).toBeInTheDocument();
    });
