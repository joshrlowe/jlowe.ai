...
describe("TagInput", () => {
  ...
  describe("rendering", () => {
    ...
    it("should use custom placeholder", () => {
      renderWithoutProviders(<TagInput {...defaultProps} placeholder="Add a tag" />);
  ...
  describe("adding tags", () => {
    it("should call onAdd when Add button is clicked with value", async () => {
      const onAdd = jest.fn();
      const { user } = renderWithoutProviders(<TagInput {...defaultProps} onAdd={onAdd} />);
  ...
  describe("accessibility", () => {
    it("should have no accessibility violations", async () => {
      const { container } = renderWithoutProviders(<TagInput {...defaultProps} label="Tags" />);
