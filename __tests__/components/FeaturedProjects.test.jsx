...
describe("FeaturedProjects Component", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should render section description", () => {
      render(<FeaturedProjects projects={mockProjects} />);
      expect(screen.getByText(/A selection of AI and engineering projects/)).toBeInTheDocument();
    });
  });
  ...
  describe("Tech Stack", () => {
    ...
    it("should handle invalid JSON in tech stack", () => {
      ...
      expect(() => render(<FeaturedProjects projects={[projectWithInvalidTech]} />)).not.toThrow();
    });
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle malformed JSON in images", () => {
      ...
      expect(() => render(<FeaturedProjects projects={[projectWithBadImages]} />)).not.toThrow();
    });
