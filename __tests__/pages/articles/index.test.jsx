...
describe("ArticlesPage", () => {
  ...
  it("should filter posts by topic", async () => {
    ...
    const topicSelect = allSelects.find(
      (select) => select.querySelector('option[value="all"]')?.textContent === "All Topics"
    );
  ...
  it("should filter posts by tag", async () => {
    ...
    const allSelects = screen.getAllByRole("combobox");
    const tagSelect = allSelects.find(
      (select) => select.querySelector('option[value="all"]')?.textContent === "All Tags"
    );
