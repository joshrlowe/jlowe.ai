...
describe("/api/home-content", () => {
  ...
  const defaultHomeContent = {
    ...
    typingStrings: expect.arrayContaining(["intelligent AI systems", "production ML pipelines"]),
    primaryCta: {
    ...
    techBadges: expect.arrayContaining([expect.objectContaining({ name: "Python" })]),
  ...
  describe("GET requests", () => {
    ...
    it("should handle database errors gracefully", async () => {
      prisma.pageContent.findUnique.mockRejectedValue(new Error("Database connection failed"));
  ...
  describe("Edge cases", () => {
    ...
    it("should handle timeout errors", async () => {
      prisma.pageContent.findUnique.mockRejectedValue(new Error("Query timeout"));
