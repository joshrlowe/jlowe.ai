...
describe("/api/admin/projects/[id]", () => {
  ...
  describe("GET requests", () => {
    ...
    it("should return project by ID with team members", async () => {
      const mockProject = {
        ...
        slug: "test-project",
        status: "Published",
        teamMembers: [{ id: "tm-1", name: "John Doe", email: "john@test.com" }],
      };
  ...
  describe("PUT requests", () => {
    ...
    it("should update project with provided data", async () => {
      ...
      prisma.project.findUnique.mockResolvedValueOnce(existingProject).mockResolvedValueOnce({
        ...existingProject,
        title: "Updated Title",
        teamMembers: [],
      });
    ...
    it("should update team members when provided", async () => {
      ...
      expect(prisma.projectTeamMember.createMany).toHaveBeenCalledWith({
        data: [{ projectId: "project-1", name: "New Member", email: "new@test.com" }],
      });
    });
