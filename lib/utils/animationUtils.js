 ...
 */
export function createFadeInAnimation({ delay = 0, duration = 0.8, ease = "power2.out" } = {}) {
  return {
    from: {
      opacity: 0,
      y: 50,
 ...
 */
export function createScrollTriggerConfig({ start = "top 85%", toggleActions = "play none none none" } = {}) {
  return {
    start,
    toggleActions,
  };
