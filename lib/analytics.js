 ...
 * @param {number} depth - The scroll depth percentage (25, 50, 75, 100)
 */
 ...
 * @param {string} articleId - The article ID
 * @param {string} articleTitle - The article title
 * @param {string} topic - The article topic/category
 */
export function trackArticleView(articleId, articleTitle, topic) {
