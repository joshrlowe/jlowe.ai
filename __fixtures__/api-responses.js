...
export const mockAbout = {
  id: "about-1",
  professionalSummary:
    "Experienced software engineer specializing in AI/ML systems and full-stack development.",
  technicalSkills: [
    {
...
export const mockPlaylist = {
  ...
  createdAt: "2024-01-01T00:00:00.000Z",
  updatedAt: "2024-01-15T00:00:00.000Z",
  playlistPosts: [{ id: "pp-1", postId: "post-1", order: 0, post: mockPost }],
  _count: {
    playlistPosts: 1,
  },
};
...
export function createPaginatedResponse(
  data,
  { total, limit = 10, offset = 0, key = "data" } = {}
) {
  return {
    [key]: data,
